...
{
    public class Etapa02_Carrinho_Item : IJob
    {
        ...
        public Task Execute(IJobExecutionContext contexta)
        {
                    ...
                    using (var objConnTess = new SqlConnection(strConnTess))
                    {
                        try
                        {
                            ...
                            if (etapa01_Carrinho.getDtRowCount() > 0)
                            {
                                ...
                                tabelaOrigem = "ESR_CARRINHO_ITEM";
                                tabelaDestino = "INTM_ESR_CARRINHO_ITEM";
                                query = $"SELECT eci.* FROM " +
                                    ...
                                    $" WHERE car.CodigoSituacaoPedido = 3 and car.DataIntegracao is null";
            ...
            catch (Exception ex)
            {
                ...
                $"Job '{nameof(Etapa02_Carrinho_Item)}' encerrado com erro",
